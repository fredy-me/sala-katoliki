...
The product authority remains [the MVP SRS](docs/srs/Sala_Katoliki_MVP_SRS_Busara_Digital.md). If this plan conflicts with the SRS, the SRS wins until an approved requirement change is recorded here.
...
- Current app version: `1.0.12+12` / `1.0.12`.
